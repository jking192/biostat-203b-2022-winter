...
### Completeness, correctness and efficiency of solution: 105/100

- Q1 (60/60) Imputation

    1.4 - use an apply statement instead of a for loop.

- Q2 (45/40) Predictive modeling

    Good to try the class weights on imbalanced data! `+5`.

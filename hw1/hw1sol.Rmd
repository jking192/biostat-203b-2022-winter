...
- `zless` is used to view the contents of a gzip compressed file screen by screen.
The spacebar can be used to move to the next page, but the mouse can also be
used to scroll through the file. Press `q` to exit.

- `zmore` is similar to `zless` but is more limited in functionality. For example,
